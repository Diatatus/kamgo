...
<body>
    ...
    <section class="container-fluid box col-lg-10 col-sm-10 col-xs-12 col-md-7  pt-lg-4 mt-lg-4 pt-sm-0 mt-sm-0 mb-5 pb-3 pt-2">
      <div class="text-center">
        <h4 class="font-weight-bold">Connectez-vous ici</h4>
      </div>
        <form action="login.php" method="post">

		<div class="form-group  row feilds ">
        <label class="col-sm-2">EMAIL</label>
            <input name="email" for="email" type="email" class="form-control-plaintext col-sm-10 arro" id="email" placeholder="Entrer votre Email" <?php if(isset($_COOKIE['email'])) { echo 'value="'.$_COOKIE['email'].'"'; } ?>required>
		</div>
		...
		<div class="form-group  row feilds ">
		  ...
		  <div class="form-group ">
                <input type="submit" class="btn green btn-primary btn-lg btn-block" id="login" name="submit" value="Se connecter">
            </div>
        </form>
    </div>
    </section>
