...
<nav class="nav nav-pills nav-justified col-sm-10">
  <a class="nav-link btn-light active" href="allusers.php">Utilisateurs</a>
  ...
  <h3 class="text-center">Utilisateurs</h3>
    ...
    <table id='tbl' class="container-fluid col-lg-10 mr-lg-2 table table-responsive table-hover table-bordered table-striped">
        <thead>
            ...
            <th onclick='sortTable(3,tbl)'>Date enregistrement ⇩</th>
        ...
        <?php 
            ...
            foreach($show as $key=>$val)
            {
              ...
              if($val['isblock']==1)
              {
                echo "<td><a class='btn btn-warning' href='allusers.php?action=blk&id=".$val['user_id']."'>Bloquer</a></td>";
              }
              if($val['isblock']==0)
              {
               echo "<td><a class='btn btn-success' href='allusers.php?action=app&id=".$val['user_id']."'>Approuver</a></td>";
              }
